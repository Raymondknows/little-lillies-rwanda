...
export async function GET(request: NextRequest) {
  try {
    ...
    let backendUrl = getBackendUrl(apiBase, '/api/admin/teacher-assignments/data');
    ...
    return NextResponse.json({ error: 'Failed to fetch teacher-assignments data' }, { status: 500 });
  }
}
