      ...
      <div className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="rounded-lg border-2 border-brand bg-brand/5 p-8">
          <div className="max-w-2xl">
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-3xl font-bold text-brand">GHS 500</span>
            </div>
            <p className="text-muted text-sm mb-6">/month, billed monthly. No setup fee.</p>
            <ul className="space-y-2 text-sm">
              {[
                "✅ Up to 1,000 students",
                "✅ Unlimited assessments & results",
                "✅ Unlimited classes",
                "✅ Momo payments included",
            ...
            <button className="mt-8 w-full rounded-lg bg-brand text-white px-6 py-3 font-medium hover:bg-brand/90">
              Start Free Trial
            </button>
          </div>
        </div>
        ...
        <div className="mt-8 p-6 rounded-lg border border-border bg-white">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {[
              { name: "Custom Domain", price: "GHS 500", freq: "one-time setup" },
              { name: "Custom Domain Hosting", price: "GHS 100-200", freq: "/month" },
              { name: "Video Tutorials (Custom)", price: "GHS 1,000", freq: "one-time" },
              { name: "Data Import (Bulk)", price: "GHS 200", freq: "one-time" },
            ].map((item, i) => (
