      ...
      <div className="hidden lg:flex lg:w-1/2 lg:flex-col lg:justify-center lg:items-center lg:bg-gradient-to-b lg:from-emerald-600 lg:to-teal-700 lg:px-16 lg:py-12 lg:relative lg:overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-8 max-w-md">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 space-y-6">
            <div>
              <p className="text-sm text-emerald-200 font-semibold mb-2">📍 Location</p>
            ...
            <div className="border-t border-white/20 pt-6">
              <p className="text-sm text-emerald-200 font-semibold mb-3">📞 Contact Us</p>
              <div className="space-y-2">
                <p className="text-white text-sm">
                  <a href="tel:+250781464730" className="hover:text-emerald-200 transition">
                    +250 781 464 730
                  </a>
                </p>
                <p className="text-white text-sm">
                  <a href="tel:+250785703719" className="hover:text-emerald-200 transition">
                    +250 785 703 719
                  </a>
                </p>
                <p className="text-white text-sm">
                  <a href="mailto:littlelillies82@gmail.com" className="hover:text-emerald-200 transition">
            ...
            <div className="border-t border-white/20 pt-6">
              <p className="text-sm text-emerald-200 font-semibold mb-2">Principal</p>
